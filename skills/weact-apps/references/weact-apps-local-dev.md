...
- 用户只想发布现成 HTML / 静态目录拿分享链接：读 [`weact-apps-html-publish.md`](weact-apps-html-publish.md)。
- 用户明确要云端妙搭 Agent 生成/迭代，而不是本地写代码：读 [`weact-apps-cloud-dev.md`](weact-apps-cloud-dev.md)。
