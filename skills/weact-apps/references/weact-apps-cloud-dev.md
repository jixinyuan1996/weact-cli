...
- 用户已有本地 HTML/dist，要马上发布 URL：读 [`weact-apps-html-publish.md`](weact-apps-html-publish.md)。
- 用户要本地写代码、改仓库、跑 dev server：读 [`weact-apps-local-dev.md`](weact-apps-local-dev.md)。
