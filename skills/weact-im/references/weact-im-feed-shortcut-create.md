...
- To inspect the current shortcut list, use [`+feed-shortcut-list`](weact-im-feed-shortcut-list.md). To remove a shortcut, use [`+feed-shortcut-remove`](weact-im-feed-shortcut-remove.md).
