...
2. 准备本地图片文件，确保格式受支持。
3. 执行 `weact-cli okr +upload-image --file ./image.png --target-id "..." --target-type objective`。
...
- [ContentBlock 格式](weact-okr-contentblock.md) -- 进展内容使用的富文本格式，包含图片块的使用说明
- [weact-okr-progress-create](weact-okr-progress-create.md) -- 创建进展记录
- [weact-okr-progress-update](weact-okr-progress-update.md) -- 更新进展记录
