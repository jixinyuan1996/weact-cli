...
> **SHORTCUT：** `okr +cycle-list` [weact-okr-cycle-list.md](weact-okr-cycle-list.md) 获取用户的周期列表，可按时间筛选
>
> **API：** `cycles.list`
...
| `content`     | `ContentBlock` | 否  | 目标内容（富文本），见 [ContentBlock 定义](weact-okr-contentblock.md) |
| `score`       | `number`       | 否  | 目标分数，范围 [0, 1]，支持一位小数                                   |
| `notes`       | `ContentBlock` | 否  | 目标备注（富文本），见 [ContentBlock 定义](weact-okr-contentblock.md) |
| `weight`      | `number`       | 否  | 目标权重，范围 [0, 1]，支持三位小数                                   |
| `deadline`    | `string`       | 否  | 截止时间，毫秒时间戳，shortcut 会将其解析为日期时间                          |
| `category_id` | `string`       | 否  | 所属分类 ID                                                 |

> **SHORTCUT：**
> - `okr +cycle-detail` [weact-okr-cycle-detail.md](weact-okr-cycle-detail.md) 获取某个用户周期下的全部目标和关键结果。时间相关的字段会以日期时间格式解析
>
> **API：**
...
| `position`     | `integer`      | 是  | 排序序号，从 1 开始，范围 [1, 100]                                   |
| `content`      | `ContentBlock` | 否  | 关键结果内容（富文本），见 [ContentBlock 定义](weact-okr-contentblock.md) |
...
| `content`       | `ContentBlock` | 否  | 进展内容（富文本），见 [ContentBlock 定义](weact-okr-contentblock.md) |
...
| 字段              | 类型             | 必填 | 说明                                                      |
|-----------------|----------------|----|---------------------------------------------------------|
| `content`       | `ContentBlock` | 是  | 进展内容（富文本），见 [ContentBlock 定义](weact-okr-contentblock.md) |
...
> **SHORTCUT：**
> - `okr +progress-get` [weact-okr-progress-get.md](weact-okr-progress-get.md) 获取单条进展记录
> - `okr +progress-create` [weact-okr-progress-create.md](weact-okr-progress-create.md) 为目标或关键结果创建进展记录
> - `okr +progress-update` [weact-okr-progress-update.md](weact-okr-progress-update.md) 更新进展记录内容
> - `okr +progress-delete` [weact-okr-progress-delete.md](weact-okr-progress-delete.md) 删除进展记录
> - `okr +progress-list` [weact-okr-progress-list.md](weact-okr-progress-list.md) 获取目标/关键结果下的进展记录
---
...
- [OKR ContentBlock 富文本格式](weact-okr-contentblock.md) — content/notes 字段的富文本结构定义
- [okr +cycle-list](weact-okr-cycle-list.md) — 列出用户 OKR 周期
- [okr +cycle-detail](weact-okr-cycle-detail.md) — 获取周期下的目标与关键结果
- [okr +progress-get](weact-okr-progress-get.md) — 获取进展记录
- [okr +progress-create](weact-okr-progress-create.md) — 创建进展记录
- [okr +progress-update](weact-okr-progress-update.md) — 更新进展记录
- [okr +progress-delete](weact-okr-progress-delete.md) — 删除进展记录
