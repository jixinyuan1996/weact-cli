...
1. Follow [`../../weact-shared/SKILL.md`](../../weact-shared/SKILL.md) for identity, auth, and permission handling.
2. For Wiki / personal library targets, follow [`../../weact-wiki/SKILL.md`](../../weact-wiki/SKILL.md).
3. For Drive folder inventory, follow [`weact-drive-files-list.md`](weact-drive-files-list.md).
4. For Drive search targets, follow [`weact-drive-search.md`](weact-drive-search.md).
5. For URL / token inspection, follow [`weact-drive-inspect.md`](weact-drive-inspect.md) and [`../../weact-wiki/references/weact-wiki-node-get.md`](../../weact-wiki/references/weact-wiki-node-get.md).
...
| Input is real keyword / name | Search with the real keyword according to `weact-drive-search` | Search scope | `INVENTORY` after user confirms scope |
| Input is range browsing / statistical description with no real keyword | Search by filters / empty-query browsing according to `weact-drive-search` | Search scope | `INVENTORY` after user confirms scope |
...
|-------|---------------------------|-----------------------|
| Wiki recursion | `max_depth=3`, `max_items=500`; follow `weact-wiki-node-list` pagination | Record queued nodes / paths in `inventory_continuation_state` and immediately continue the next internal batch within the confirmed scope unless blocked |
...
1. Follow [`../../weact-wiki/references/weact-wiki-node-list.md`](../../weact-wiki/references/weact-wiki-node-list.md) traversal semantics.
...
1. Use `drive files list` according to [`weact-drive-files-list.md`](weact-drive-files-list.md); its schema path is `drive.files.list`.
...
| Missing API scope | Follow `weact-shared` permission handling and stop | Do not retry the same command repeatedly |
