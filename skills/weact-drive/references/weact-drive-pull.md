...
weact-cli drive +pull --local-dir ./repo --folder-token fldcnxxxxxxxxx
...
- [weact-drive-status](weact-drive-status.md) —— 下载前先看差异
- [weact-drive-download](weact-drive-download.md) —— 单文件按需拉取
