...
Before running this workflow, MUST read [`../../weact-shared/SKILL.md`](../../weact-shared/SKILL.md) for identity, authentication, permission handling, and write-operation confirmation rules.

Load other skills / references progressively:

- Wiki / personal library target: [`../../weact-wiki/SKILL.md`](../../weact-wiki/SKILL.md)
- Content read required: [`../../weact-doc/SKILL.md`](../../weact-doc/SKILL.md) and [`../../weact-doc/references/weact-doc-fetch.md`](../../weact-doc/references/weact-doc-fetch.md)
- Sheet down-drill required: [`../../weact-sheets/SKILL.md`](../../weact-sheets/SKILL.md)
- Base down-drill required: [`../../weact-base/SKILL.md`](../../weact-base/SKILL.md)
...
|------|------|--------------|
| `weact-drive-workflow-knowledge-organize.md` | Workflow trigger, global contract, state machine, progressive load map, command family allowlist | Stage-specific rules, output templates, execution details |
| `weact-drive-workflow-knowledge-organize-discovery.md` | `PARSE_SCOPE`, `INVENTORY`, target parsing, stop conditions, inventory limits, `ResourceItem` | Classification, plan generation, write execution |
| `weact-drive-workflow-knowledge-organize-analysis.md` | `CONTENT_READ`, `ISSUE_ANALYSIS`, `RULE_GENERATION`, low-confidence reads, issue rules, problem pagination, classification, target tree | Plan execution, write confirmation, verification |
| `weact-drive-workflow-knowledge-organize-planning.md` | `PLAN_GENERATION`, `EXEC_CONFIRM`, `PlanItem`, `DisplayItem`, plan pagination, plan revision, execution scope confirmation | Scope parsing, resource inventory, write execution, verification |
| `weact-drive-workflow-knowledge-organize-execution.md` | `EXECUTE`, `VERIFY`, `PathTokenMap`, write execution, progress reporting, verification, next suggestions, internal recovery hooks | Scope parsing, resource inventory, classification, plan generation, plan revision, rollback execution details |
| `weact-drive-workflow-knowledge-organize-rollback.md` | `ROLLBACK_CONFIRM`, `ROLLBACK`, `ROLLBACK_VERIFY`, `ROLLBACK_CLEANUP_CONFIRM`, `ROLLBACK_CLEANUP`, `ROLLBACK_CLEANUP_VERIFY`, recovery plan generation, recovery execution, cleanup verification | Scope parsing, resource inventory, classification, organization plan generation, normal write execution |
...
|-------|---------------------|
| `PARSE_SCOPE` | [`weact-drive-workflow-knowledge-organize-discovery.md`](weact-drive-workflow-knowledge-organize-discovery.md) |
| `INVENTORY` | [`weact-drive-workflow-knowledge-organize-discovery.md`](weact-drive-workflow-knowledge-organize-discovery.md) |
| `CONTENT_READ` | [`weact-drive-workflow-knowledge-organize-analysis.md`](weact-drive-workflow-knowledge-organize-analysis.md) |
| `ISSUE_ANALYSIS` | [`weact-drive-workflow-knowledge-organize-analysis.md`](weact-drive-workflow-knowledge-organize-analysis.md) |
| `RULE_GENERATION` | [`weact-drive-workflow-knowledge-organize-analysis.md`](weact-drive-workflow-knowledge-organize-analysis.md) |
| `PLAN_GENERATION` | [`weact-drive-workflow-knowledge-organize-planning.md`](weact-drive-workflow-knowledge-organize-planning.md) |
| `EXEC_CONFIRM` | [`weact-drive-workflow-knowledge-organize-planning.md`](weact-drive-workflow-knowledge-organize-planning.md) |
| `EXECUTE` | [`weact-drive-workflow-knowledge-organize-execution.md`](weact-drive-workflow-knowledge-organize-execution.md) |
| `VERIFY` | [`weact-drive-workflow-knowledge-organize-execution.md`](weact-drive-workflow-knowledge-organize-execution.md) |
| `ROLLBACK_CONFIRM` | [`weact-drive-workflow-knowledge-organize-rollback.md`](weact-drive-workflow-knowledge-organize-rollback.md) |
| `ROLLBACK` | [`weact-drive-workflow-knowledge-organize-rollback.md`](weact-drive-workflow-knowledge-organize-rollback.md) |
| `ROLLBACK_VERIFY` | [`weact-drive-workflow-knowledge-organize-rollback.md`](weact-drive-workflow-knowledge-organize-rollback.md) |
| `ROLLBACK_CLEANUP_CONFIRM` | [`weact-drive-workflow-knowledge-organize-rollback.md`](weact-drive-workflow-knowledge-organize-rollback.md) |
| `ROLLBACK_CLEANUP` | [`weact-drive-workflow-knowledge-organize-rollback.md`](weact-drive-workflow-knowledge-organize-rollback.md) |
| `ROLLBACK_CLEANUP_VERIFY` | [`weact-drive-workflow-knowledge-organize-rollback.md`](weact-drive-workflow-knowledge-organize-rollback.md) |
...
| `CONTENT_READ` | `docs +fetch`, plus `weact-sheets` / `weact-base` when conditionally required | Partial content read for low-confidence items |
...
2. If auth or API scope is missing, follow `weact-shared` permission handling and stop.
...
- [Discovery phase](weact-drive-workflow-knowledge-organize-discovery.md)
- [Analysis phase](weact-drive-workflow-knowledge-organize-analysis.md)
- [Planning phase](weact-drive-workflow-knowledge-organize-planning.md)
- [Execution phase](weact-drive-workflow-knowledge-organize-execution.md)
- [Rollback phase](weact-drive-workflow-knowledge-organize-rollback.md)
- [weact-shared](../../weact-shared/SKILL.md)
- [weact-drive](../SKILL.md)
- [weact-drive-files-list](weact-drive-files-list.md)
- [weact-drive-search](weact-drive-search.md)
- [weact-drive-inspect](weact-drive-inspect.md)
- [weact-drive-apply-permission](weact-drive-apply-permission.md)
- [weact-drive-task-result](weact-drive-task-result.md)
- [weact-drive-delete](weact-drive-delete.md)
- [weact-wiki](../../weact-wiki/SKILL.md)
- [weact-wiki-node-delete](../../weact-wiki/references/weact-wiki-node-delete.md)
- [weact-doc](../../weact-doc/SKILL.md)
- [weact-doc-fetch](../../weact-doc/references/weact-doc-fetch.md)
- [weact-sheets](../../weact-sheets/SKILL.md)
- [weact-base](../../weact-base/SKILL.md)
