...
1. `resource_items` MUST already exist from [`weact-drive-workflow-knowledge-organize-discovery.md`](weact-drive-workflow-knowledge-organize-discovery.md).
2. For document partial reads, follow [`../../weact-doc/SKILL.md`](../../weact-doc/SKILL.md) and [`../../weact-doc/references/weact-doc-fetch.md`](../../weact-doc/references/weact-doc-fetch.md).
3. For sheet / bitable down-drill, follow [`../../weact-sheets/SKILL.md`](../../weact-sheets/SKILL.md) or [`../../weact-base/SKILL.md`](../../weact-base/SKILL.md) only when title and path are insufficient.
...
3. Read only supported docs through `weact-doc-fetch`.
4. Switch to `weact-sheets` / `weact-base` only when sheet / bitable title and path are insufficient.
...
| Resource is low-confidence and docs-fetch-supported | Read outline via `weact-doc-fetch` | Do not skip partial read |
...
| Partial read returns usable block id and classification is still unclear | Read the relevant section via `weact-doc-fetch` | Do not read the full document |
