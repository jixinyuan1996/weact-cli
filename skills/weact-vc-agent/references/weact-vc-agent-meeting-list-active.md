...
- [weact-vc-agent-meeting-join](weact-vc-agent-meeting-join.md) — 让应用机器人真实入会并拿 `meeting.id`
- [weact-vc-agent-meeting-events](weact-vc-agent-meeting-events.md) — 使用 `meeting_id` 读取会中事件
