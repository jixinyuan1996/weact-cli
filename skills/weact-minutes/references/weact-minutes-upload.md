...
> **边界说明**：`minutes +upload` 本身只负责把文件转成妙记并返回 `minute_url`。纪要内容、逐字稿、文字稿、撰写文字、总结、待办、章节属于后续产物获取，应由 [minutes +detail](weact-minutes-detail.md) 承接。
...
- [drive +upload](../../weact-drive/references/weact-drive-upload.md) -- 上传文件到云空间（云盘/云存储）
