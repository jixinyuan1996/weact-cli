...
> **路由**：本命令操作**妙记内的 AI 待办**，不是飞书任务（Task）。用户说「在妙记里新建待办」时**必须**用本命令，**禁止**走 `weact-cli task` / `tasklists list` / `task +create`。详见 [weact-minutes/SKILL.md](../SKILL.md) 第 6 节。
...
- [weact-minutes](../SKILL.md)
- [minutes +summary](weact-minutes-summary.md)
- [minutes +detail](weact-minutes-detail.md)
