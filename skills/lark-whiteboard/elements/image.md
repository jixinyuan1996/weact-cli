...
| 文档中的图片 token | `weact-cli docs +media-download --token <token> --output ./photo.png` |
| 其他域的 Drive token | `weact-cli docs +media-download --token <token> --output ./photo.png` |
...
```bash
weact-cli docs +media-upload --file ./photo1.jpg --parent-type whiteboard --parent-node <whiteboard_token>
...
```bash
weact-cli docs +media-upload --file ./photo1.jpg --parent-type whiteboard --parent-node <whiteboard_token>  # → <media_token_1>
weact-cli docs +media-upload --file ./photo2.jpg --parent-type whiteboard --parent-node <whiteboard_token>  # → <media_token_2>
weact-cli docs +media-upload --file ./photo3.jpg --parent-type whiteboard --parent-node <whiteboard_token>  # → <media_token_3>
```
