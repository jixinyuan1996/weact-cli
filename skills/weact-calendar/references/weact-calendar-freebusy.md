...
- [weact-calendar-agenda](weact-calendar-agenda.md) — 查看日程安排
- [weact-calendar-create](weact-calendar-create.md) — 创建日程
- [weact-calendar-suggestion](weact-calendar-suggestion.md) — 根据非明确时间或一段时间范围，推荐多个可用时间块方案
- [weact-calendar](../SKILL.md) — 日历完整 API
