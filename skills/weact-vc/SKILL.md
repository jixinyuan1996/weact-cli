...
| Shortcut | 说明 |
|----------|------|
| [`+search`](referenc../weact-vc-search.md) | 搜索历史会议记录（需至关键词、时间范围、组织者、参与者、会议室少一个筛选条件） |
| [`+detail`](referenc../weact-vc-detail.md) | 通过 meeting-ids 获取会议详情，包括 note_id 和 minute_token |
| [`+recording`](referenc../weact-vc-recording.md) | 通过 meeting-ids 或 calendar-event-ids 查询 minute_token |
