...
This guide is the entry point for `+data-query`. Use it for common aggregation fewshots and command selection. For the complete DSL fields, operators, limits, and response details, use [weact-base-data-query.md](weact-base-data-query.md) as the DSL SSOT.

Before using `+data-query`, also follow [weact-base-data-analysis-sop.md](weact-base-data-analysis-sop.md) to confirm that the task really needs aggregation instead of record listing or a temporary view.
...
Read [weact-base-data-query.md](weact-base-data-query.md) when you need:
