...
| `--output-dir` | 否 | 输出目录，默认 `.weact-slides/screenshots`；必须是当前目录内的相对路径 |
...
weact-cli slides +screenshot --as user \
  ...
  --slide-number 1 \
  --slide-number 2 \
  --output-dir .weact-slides/screenshots/demo
```
...
```bash
weact-cli slides +screenshot --as user \
  --content @.weact-slides/out/demo/slide.xml \
  --output-name preview
```
...
```json
{
  ...
  "data": {
    ...
    "output_dir": ".weact-slides/screenshots",
    "screenshots": [
      {
        "slide_id": "slide_example_id",
        "slide_number": 1,
        "format": "png",
        "path": "/abs/path/.weact-slides/screenshots/slides_example_presentation_id_p001_slide_example_id.png",
        "size": 12345
      }
    ]
  },
