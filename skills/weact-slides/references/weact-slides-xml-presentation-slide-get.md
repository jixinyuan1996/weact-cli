# weact-slides xml_presentation.slide get
...
- [slides +replace-slide](weact-slides-replace-slide.md) — 块级替换 shortcut（推荐）
- [xml_presentation.slide replace](weact-slides-xml-presentation-slide-replace.md) — 底层 replace API 参考
- [xml_presentations get](weact-slides-xml-presentations-get.md) — 读整个 PPT
- [weact-slides-edit-workflows.md](weact-slides-edit-workflows.md) — 读-改-写闭环
